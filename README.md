...
Thanks to some bytecode modification, which can be done on-the-fly, you can use simple and advanced goto constructs in Java. (Not that you should ... [evil grin] ... but now you can!)
