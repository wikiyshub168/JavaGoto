...
public final class GotoLoader extends ClassLoader {
     ...
     *
     */
    private synchronized Class loadGotoEnabledClass(String className) throws ClassNotFoundException, DuplicateLabel, LabelNotFound, IOException, Exception {
...
//        }
    ...
    public static Class<?> load(String name) throws ClassNotFoundException, Exception {
        Class c = g2l.loadClass(name);
        return (c != null) ? c : null;
    }

    public static Object newInstance(String name) throws ClassNotFoundException, Exception {
        Class c = load(name);
